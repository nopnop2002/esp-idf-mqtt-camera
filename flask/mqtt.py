...
parser.add_argument('--subtopic', default="/image/esp32cam", help='mqtt subscribe topic')
parser.add_argument('--pubtopic', default="/topic/picture/sub", help='mqtt publish topic')
